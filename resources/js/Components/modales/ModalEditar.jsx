...
export default function ModalEditar({ isVisible, onClose, children, titulo }) {
  useEffect(() => {
    if (isVisible) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 px-2 sm:px-0">
      ...
      <div className="relative flex justify-center items-center bg-white rounded-md shadow-xl px-6 py-6 max-w-xl w-full border border-gray-300 transition-transform transform hover:scale-105">
        <button
